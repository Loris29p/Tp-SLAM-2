...
<html>
    ...
    <h2>Liste Adresses</h2>
        ...
        <table style="width:100%">
            ...
            <?php
                foreach($_GET as $users)
                {
                    echo "<tr>";
                    echo "<td>".$users["id"]."</td>";
                    echo "<td>".$users["num_street"]."</td>";
                    echo "<td>".$users["name_street"]."</td>";
                    echo "<td>".$users["city"]."</td>";
                    echo "<td>".$users["cp"]."</td>";
                    echo '<td> <a href="../controller/DeleteAdressesController.php?id='.$users['id'].'"> Supprimer </a></td>'; 
                    echo "</tr>";
                }
            ?>
        </table>
